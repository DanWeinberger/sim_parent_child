...
Prevalence gives probability that a person sampled on a random day will be positive. If adults and kids are independent, prev1*prev2=prev1_2. but because they are dependent, prev1_2 > prev1 x prev2. it is something like prev1xprev2 + prev1_from2 + prev2_from1 where prev1_from 2 is prevalence in person 1 resulting from transmission from person 2
